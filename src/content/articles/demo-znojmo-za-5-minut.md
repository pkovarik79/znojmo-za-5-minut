...
Tento ukázkový článek slouží pro ověření vzhledu webu a content kolekce.

Skutečné návrhy bude vytvářet scraper v adresáři `src/content/articles/` s hodnotou `draft: true`. Editor je může upravit, ověřit a přepnout na `draft: false`.
